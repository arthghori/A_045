...
<body>
    <form id="form1" runat="server">
        <table cellpadding="3" cellspacing="3" class="auto-style1">
            ...
            <tr>
                <td class="auto-style4" colspan="2">
                    <asp:GridView ID="gvdepa" runat="server" OnSelectedIndexChanged="gvdepa_SelectedIndexChanged" AutoGenerateSelectButton="True" AutoGenerateDeleteButton="True" OnRowDeleting="gvdepa_RowDeleting" OnSelectedIndexChanging="gvdepa_SelectedIndexChanging">
                    </asp:GridView>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style8" colspan="2">
                    ...
                    <asp:Button ID="btnre" runat="server" Height="32px" OnClick="btnre_Click" Text="Reset" Width="126px" />
                    <asp:Button ID="btnDelete" runat="server" Height="42px" OnClick="btnDelete_Click" Text="Delete" Width="126px" />
                </td>
            </tr>
        </table>
    </form>
